...
class CallExpr(Expr):
    ...
    def eval(self, env):
        ...
        try:
            ...
            operands_eval = [operand.eval(env) for operand in self.operands]
...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        # Create a new env with Lambda Function arguments
        arg_pairs = zip(self.parameters, arguments)
        for arg_pair in arg_pairs:
            env_copy[arg_pair[0]] = arg_pair[1]
        # Use the new env to eval Lambda Function body
